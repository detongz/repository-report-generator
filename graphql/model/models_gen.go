...
type AddProjectNextItemPayload struct {
	...
	ProjectNextItem *ProjectNextItem `json:"projectNextItem"`
}
...
type CancelSponsorshipInput struct {
	...
	SponsorableID *string `json:"sponsorableId"`
...
type CreateBranchProtectionRuleInput struct {
	...
	BypassForcePushActorIds []string `json:"bypassForcePushActorIds"`
	// A list of User or Team IDs allowed to bypass pull requests targeting matching branches.
	BypassPullRequestActorIds []string `json:"bypassPullRequestActorIds"`
	// A unique identifier for the client performing the mutation.
	ClientMutationID *string `json:"clientMutationId"`
	// Will new commits pushed to matching branches dismiss pull request review approvals.
	DismissesStaleReviews *bool `json:"dismissesStaleReviews"`
...
type DependencyGraphDependencyConnection struct {
	// A list of edges.
	Edges []*DependencyGraphDependencyEdge `json:"edges"`
	// A list of nodes.
	Nodes []*DependencyGraphDependency `json:"nodes"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int `json:"totalCount"`
...
type DependencyGraphDependencyEdge struct {
	...
	Cursor string `json:"cursor"`
	// The item at the end of the edge.
	Node *DependencyGraphDependency `json:"node"`
}
...
type DependencyGraphManifest struct {
	...
	Dependencies *DependencyGraphDependencyConnection `json:"dependencies"`
...
type DependencyGraphManifestConnection struct {
	// A list of edges.
	Edges []*DependencyGraphManifestEdge `json:"edges"`
	// A list of nodes.
...
type DependencyGraphManifestEdge struct {
	...
	Cursor string `json:"cursor"`
	// The item at the end of the edge.
	Node *DependencyGraphManifest `json:"node"`
}
...
type DeploymentRequest struct {
	...
	// The wait timer in minutes configured in the environment
	WaitTimerStartedAt *string `json:"waitTimerStartedAt"`
}
...
type DraftIssue struct {
	...
	Project *ProjectNext `json:"project"`
	// The project item that wraps this draft issue.
	ProjectItem *ProjectNextItem `json:"projectItem"`
...
type Issue struct {
	...
	ProjectNext *ProjectNext `json:"projectNext"`
	// List of project (beta) items associated with this issue.
	ProjectNextItems *ProjectNextItemConnection `json:"projectNextItems"`
	// A list of projects (beta) under the owner.
	ProjectsNext *ProjectNextConnection `json:"projectsNext"`
	// Identifies when the comment was published at.
	PublishedAt *string `json:"publishedAt"`
	// A list of reactions grouped by content left on the subject.
	ReactionGroups []*ReactionGroup `json:"reactionGroups"`
...
type ProjectNext struct {
	...
	Fields *ProjectNextFieldConnection `json:"fields"`
	ID     string                      `json:"id"`
	// List of items in the project
	Items *ProjectNextItemConnection `json:"items"`
	// The project's number.
	Number int `json:"number"`
	// The project's owner. Currently limited to organizations and users.
	Owner ProjectNextOwner `json:"owner"`
	...
	Views *ProjectViewConnection `json:"views"`
}
...
type ProjectNextConnection struct {
	// A list of edges.
	Edges []*ProjectNextEdge `json:"edges"`
	// A list of nodes.
	Nodes []*ProjectNext `json:"nodes"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int `json:"totalCount"`
...
type ProjectNextFieldConnection struct {
	// A list of edges.
	Edges []*ProjectNextFieldEdge `json:"edges"`
	// A list of nodes.
	Nodes []*ProjectNextField `json:"nodes"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int `json:"totalCount"`
...
type ProjectNextFieldEdge struct {
	...
	Cursor string `json:"cursor"`
	// The item at the end of the edge.
	Node *ProjectNextField `json:"node"`
}

// An item within a new Project.
type ProjectNextItem struct {
	// The content of the referenced draft issue, issue, or pull request
	Content ProjectNextItemContent `json:"content"`
	// Identifies the date and time when the object was created.
	CreatedAt string `json:"createdAt"`
	...
	FieldValues *ProjectNextItemFieldValueConnection `json:"fieldValues"`
	ID          string                               `json:"id"`
	...
	Type ProjectItemType `json:"type"`
	// Identifies the date and time when the object was last updated.
	UpdatedAt string `json:"updatedAt"`
}
...
type ProjectNextItemConnection struct {
	// A list of edges.
	Edges []*ProjectNextItemEdge `json:"edges"`
	// A list of nodes.
	Nodes []*ProjectNextItem `json:"nodes"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int `json:"totalCount"`
...
type ProjectNextItemEdge struct {
	...
	Cursor string `json:"cursor"`
	// The item at the end of the edge.
	Node *ProjectNextItem `json:"node"`
}
...
type ProjectNextItemFieldValue struct {
	...
	ProjectField *ProjectNextField `json:"projectField"`
...
type ProjectNextItemFieldValueConnection struct {
	// A list of edges.
	Edges []*ProjectNextItemFieldValueEdge `json:"edges"`
	// A list of nodes.
	Nodes []*ProjectNextItemFieldValue `json:"nodes"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int `json:"totalCount"`
...
type ProjectNextItemFieldValueEdge struct {
	...
	Cursor string `json:"cursor"`
	// The item at the end of the edge.
	Node *ProjectNextItemFieldValue `json:"node"`
}
...
type ProjectView struct {
	...
	VerticalGroupBy []int `json:"verticalGroupBy"`
...
type ProjectViewConnection struct {
	// A list of edges.
	Edges []*ProjectViewEdge `json:"edges"`
	// A list of nodes.
	Nodes []*ProjectView `json:"nodes"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int `json:"totalCount"`
...
type Repository struct {
	...
	DependencyGraphManifests *DependencyGraphManifestConnection `json:"dependencyGraphManifests"`
...
type Team struct {
	...
	ReviewRequestDelegationAlgorithm *TeamReviewAssignmentAlgorithm `json:"reviewRequestDelegationAlgorithm"`
	// True if review assignment is enabled for this team
	ReviewRequestDelegationEnabled bool `json:"reviewRequestDelegationEnabled"`
	// How many team members are required for review assignment for this team
	ReviewRequestDelegationMemberCount *int `json:"reviewRequestDelegationMemberCount"`
...
func (e DependencyGraphEcosystem) IsValid() bool {
	switch e {
	case DependencyGraphEcosystemActions, DependencyGraphEcosystemComposer, DependencyGraphEcosystemGo, DependencyGraphEcosystemMaven, DependencyGraphEcosystemNpm, DependencyGraphEcosystemNuget, DependencyGraphEcosystemPip, DependencyGraphEcosystemRubygems:
		return true
	}
	return false
}
...
func (e DeploymentState) IsValid() bool {
	switch e {
	case DeploymentStateAbandoned, DeploymentStateActive, DeploymentStateDestroyed, DeploymentStateError, DeploymentStateFailure, DeploymentStateInactive, DeploymentStateInProgress, DeploymentStatePending, DeploymentStateQueued, DeploymentStateWaiting:
		return true
	}
	return false
}
...
func (e EnterpriseAdministratorRole) IsValid() bool {
	switch e {
	case EnterpriseAdministratorRoleBillingManager, EnterpriseAdministratorRoleOwner:
		return true
	}
	return false
}
...
func (e FundingPlatform) IsValid() bool {
	switch e {
	case FundingPlatformCommunityBridge, FundingPlatformCustom, FundingPlatformGithub, FundingPlatformIssuehunt, FundingPlatformKoFi, FundingPlatformLfxCrowdfunding, FundingPlatformLiberapay, FundingPlatformOpenCollective, FundingPlatformOtechie, FundingPlatformPatreon, FundingPlatformTidelift:
		return true
	}
	return false
}
...
func (e MigrationSourceType) IsValid() bool {
	switch e {
	case MigrationSourceTypeAzureDevops, MigrationSourceTypeBitbucketServer, MigrationSourceTypeGithub, MigrationSourceTypeGithubArchive, MigrationSourceTypeGitlab:
		return true
	}
	return false
}
...
func (e MigrationState) IsValid() bool {
	switch e {
	case MigrationStateFailed, MigrationStateInProgress, MigrationStateNotStarted, MigrationStateQueued, MigrationStateSucceeded:
		return true
	}
	return false
}
...
func (e OrgRemoveMemberAuditEntryMembershipType) IsValid() bool {
	switch e {
	case OrgRemoveMemberAuditEntryMembershipTypeAdmin, OrgRemoveMemberAuditEntryMembershipTypeBillingManager, OrgRemoveMemberAuditEntryMembershipTypeDirectMember, OrgRemoveMemberAuditEntryMembershipTypeOutsideCollaborator, OrgRemoveMemberAuditEntryMembershipTypeUnaffiliated:
		return true
	}
	return false
}
...
const (
	// Draft Issue
	ProjectItemTypeDraftIssue ProjectItemType = "DRAFT_ISSUE"
	// Issue
	ProjectItemTypeIssue ProjectItemType = "ISSUE"
	// Pull Request
	ProjectItemTypePullRequest ProjectItemType = "PULL_REQUEST"
	// Redacted Item
	ProjectItemTypeRedacted ProjectItemType = "REDACTED"
)

var AllProjectItemType = []ProjectItemType{
	ProjectItemTypeDraftIssue,
	ProjectItemTypeIssue,
	ProjectItemTypePullRequest,
	ProjectItemTypeRedacted,
}

func (e ProjectItemType) IsValid() bool {
	switch e {
	case ProjectItemTypeDraftIssue, ProjectItemTypeIssue, ProjectItemTypePullRequest, ProjectItemTypeRedacted:
		return true
	}
	return false
}

func (e ProjectItemType) String() string {
	return string(e)
}

func (e *ProjectItemType) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = ProjectItemType(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ProjectItemType", str)
	}
	return nil
}

func (e ProjectItemType) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
...
const (
	...
	// Tracks
	ProjectNextFieldTypeTracks ProjectNextFieldType = "TRACKS"
)
...
var AllProjectNextFieldType = []ProjectNextFieldType{
	...
	ProjectNextFieldTypeTracks,
}

func (e ProjectNextFieldType) IsValid() bool {
	switch e {
	case ProjectNextFieldTypeAssignees, ProjectNextFieldTypeDate, ProjectNextFieldTypeIteration, ProjectNextFieldTypeLabels, ProjectNextFieldTypeLinkedPullRequests, ProjectNextFieldTypeMilestone, ProjectNextFieldTypeNumber, ProjectNextFieldTypeRepository, ProjectNextFieldTypeReviewers, ProjectNextFieldTypeSingleSelect, ProjectNextFieldTypeText, ProjectNextFieldTypeTitle, ProjectNextFieldTypeTracks:
		return true
	}
	return false
}
...
func (e ProjectNextOrderField) IsValid() bool {
	switch e {
	case ProjectNextOrderFieldCreatedAt, ProjectNextOrderFieldNumber, ProjectNextOrderFieldTitle, ProjectNextOrderFieldUpdatedAt:
		return true
	}
	return false
}
...
const (
	// Board layout
	ProjectViewLayoutBoardLayout ProjectViewLayout = "BOARD_LAYOUT"
	// Table layout
	ProjectViewLayoutTableLayout ProjectViewLayout = "TABLE_LAYOUT"
)

var AllProjectViewLayout = []ProjectViewLayout{
	ProjectViewLayoutBoardLayout,
	ProjectViewLayoutTableLayout,
}

func (e ProjectViewLayout) IsValid() bool {
	switch e {
	case ProjectViewLayoutBoardLayout, ProjectViewLayoutTableLayout:
		return true
	}
	return false
}

func (e ProjectViewLayout) String() string {
	return string(e)
}

func (e *ProjectViewLayout) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = ProjectViewLayout(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ProjectViewLayout", str)
	}
	return nil
}

func (e ProjectViewLayout) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
...
func (e ReportedContentClassifiers) IsValid() bool {
	switch e {
	case ReportedContentClassifiersAbuse, ReportedContentClassifiersDuplicate, ReportedContentClassifiersOffTopic, ReportedContentClassifiersOutdated, ReportedContentClassifiersResolved, ReportedContentClassifiersSpam:
		return true
	}
	return false
}
...
func (e RepositoryInteractionLimit) IsValid() bool {
	switch e {
	case RepositoryInteractionLimitCollaboratorsOnly, RepositoryInteractionLimitContributorsOnly, RepositoryInteractionLimitExistingUsers, RepositoryInteractionLimitNoLimit:
		return true
	}
	return false
}
...
func (e RepositoryInteractionLimitExpiry) IsValid() bool {
	switch e {
	case RepositoryInteractionLimitExpiryOneDay, RepositoryInteractionLimitExpiryOneMonth, RepositoryInteractionLimitExpiryOneWeek, RepositoryInteractionLimitExpirySixMonths, RepositoryInteractionLimitExpiryThreeDays:
		return true
	}
	return false
}
...
func (e RepositoryInteractionLimitOrigin) IsValid() bool {
	switch e {
	case RepositoryInteractionLimitOriginOrganization, RepositoryInteractionLimitOriginRepository, RepositoryInteractionLimitOriginUser:
		return true
	}
	return false
}
...
func (e RepositoryLockReason) IsValid() bool {
	switch e {
	case RepositoryLockReasonBilling, RepositoryLockReasonMigrating, RepositoryLockReasonMoving, RepositoryLockReasonRename:
		return true
	}
	return false
}
...
func (e RepositoryVulnerabilityAlertState) IsValid() bool {
	switch e {
	case RepositoryVulnerabilityAlertStateDismissed, RepositoryVulnerabilityAlertStateFixed, RepositoryVulnerabilityAlertStateOpen:
		return true
	}
	return false
}
...
func (e SponsorsActivityAction) IsValid() bool {
	switch e {
	case SponsorsActivityActionCancelledSponsorship, SponsorsActivityActionNewSponsorship, SponsorsActivityActionPendingChange, SponsorsActivityActionRefund, SponsorsActivityActionSponsorMatchDisabled, SponsorsActivityActionTierChange:
		return true
	}
	return false
}
...
func (e SponsorsActivityPeriod) IsValid() bool {
	switch e {
	case SponsorsActivityPeriodAll, SponsorsActivityPeriodDay, SponsorsActivityPeriodMonth, SponsorsActivityPeriodWeek:
		return true
	}
	return false
}
...
func (e SponsorsGoalKind) IsValid() bool {
	switch e {
	case SponsorsGoalKindMonthlySponsorshipAmount, SponsorsGoalKindTotalSponsorsCount:
		return true
	}
	return false
}
...
func (e SponsorshipPrivacy) IsValid() bool {
	switch e {
	case SponsorshipPrivacyPrivate, SponsorshipPrivacyPublic:
		return true
	}
	return false
}
...
func (e TopicSuggestionDeclineReason) IsValid() bool {
	switch e {
	case TopicSuggestionDeclineReasonNotRelevant, TopicSuggestionDeclineReasonPersonalPreference, TopicSuggestionDeclineReasonTooGeneral, TopicSuggestionDeclineReasonTooSpecific:
		return true
	}
	return false
}
...
func (e TrackedIssueStates) IsValid() bool {
	switch e {
	case TrackedIssueStatesClosed, TrackedIssueStatesOpen:
		return true
	}
	return false
}
